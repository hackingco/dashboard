# @swarm-orchestration/langfuse-wrapper

> Advanced Langfuse integration with Claude Flow hooks, real-time monitoring, and swarm coordination

A comprehensive Langfuse integration wrapper for Swarm orchestration with auto-registration, memory coordination, real-time monitoring, and advanced Claude-Flow hooks support.
...
```typescript
import { LangfuseWrapper } from '@swarm-orchestration/langfuse-wrapper';
