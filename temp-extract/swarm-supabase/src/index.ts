...
export const swarmOperations = {
  async create(data: Database['public']['Tables']['swarms']['Insert']) {
  ...
  async update(id: string, updates: Database['public']['Tables']['swarms']['Update']) {
    const client = getSupabaseClient();
    const { data, error } = await client
      .from('swarms')
      .update(updates)
...
export const workerOperations = {
  async create(data: Database['public']['Tables']['workers']['Insert']) {
    const client = getSupabaseClient();
...
export const logOperations = {
  async create(data: Database['public']['Tables']['logs']['Insert']) {
    const client = getSupabaseClient();
    const { error } = await client
      .from('logs')
      .insert(data);
...
export const metricsOperations = {
  async record(data: Database['public']['Tables']['metrics']['Insert']) {
    const client = getSupabaseClient();
    const { error } = await client
      .from('metrics')
      .insert(data);
